...
- [ ] Реализовать веб-форму гонки (`moto.local`) с вводом имени и кнопками «Занять трек»/«Сброс», тянущую режим и круги из админки.
  ...
  - [ ] Реализовать back-end логику блокировки трассы на модуле: API флаг «track locked», распространение события всем клиентам и освобождение после финиша/сброса.
  - [ ] Адаптировать dev-server и SPA под режим ожидания: «трек занят», лайв-таймер активного пилота, отсутствие возможности занять трек.
  - [ ] Перенести ту же логику ожидания на прошивку/реальный API после обкатки на dev-server.
